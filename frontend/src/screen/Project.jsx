...
const Project = () => {
    ...
    const send = async () => {
        ...
        // Send real-time message (assuming WebSockets or similar)
        sendMessage("project-message", {
            message,
            sender: user
        });
        ...
        // Update messages state in the frontend
                ...
                <div className="conversation-area pt-14 pb-10 flex-grow flex flex-col h-full relative">
                    ...
                    <div className="inputField w-full flex absolute bottom-0">
                        <input
                            ...
                            className='p-2 px-4 border-none outline-none flex-grow' type="text" placeholder='Enter message here : use @ai for AI' />
                        <button
                            onClick={send}
                        ...
                        <div className="actions flex gap-2">
                            <button
                                onClick={async () => {
                                    ...
                                    const installAndRunProcess = await webContainer.spawn("sh", ["-c", "npm install && npm start"]);

                                    installAndRunProcess.output.pipeTo(new WritableStream({
                                        write(chunk) {
                                            console.log(chunk);
                                        }
                                    }));
                                    ...
                                    setRunProcess(installAndRunProcess);
                                ...
                                className='p-2 px-4 bg-red-500 text-white cursor-pointer text-xl font-semibold'
                            >
                                run
                            </button>
