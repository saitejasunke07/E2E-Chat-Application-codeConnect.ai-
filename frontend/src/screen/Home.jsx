    ...
    <div>
      <main className='p-4'>
        <div className="logout-btn">
          ...
          className='bg-red-500 p-2 rounded mb-4 text-white text-md font-semibold cursor-pointer'
          >Logout</button>
        </div>
                    ...
                    <div className="bg-white p-6 rounded-md shadow-md w-1/3">
                        ...
                        <form onSubmit={createProject}>
                            ...
                            <div className="flex justify-end">
                                ...
                                <button type="submit" className="px-4 py-2 bg-blue-600 text-black rounded-md">Create</button>
                            </div>
                        </form>
                    </div>
                </div>
